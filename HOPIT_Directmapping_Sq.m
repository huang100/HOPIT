function [LLV,score] = HOPIT_Directmapping_Sq(Data,b,cut_point)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for i=Unique_Outcome(1):Unique_Outcome(end)
    ...
    npdf_1_beta(id)=normpdf((Zb(id,i+1)-Xb(id))./Vb(id));
    npdf_beta(id)=normpdf((Zb(id,i)-Xb(id))./Vb(id));
    ncdf_1_beta(id)=normcdf((Zb(id,i+1)-Xb(id))./Vb(id));
    ncdf_beta(id)=normcdf((Zb(id,i)-Xb(id))./Vb(id));
    ncdf_1_beta_alter(id)=normcdf(-((Zb(id,i+1)-Xb(id)))./Vb(id));
    ncdf_beta_alter(id)=normcdf(-((Zb(id,i)-Xb(id)))./Vb(id));
end
