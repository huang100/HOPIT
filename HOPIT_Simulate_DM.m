function Simulated=HOPIT_Simulate_DM(Pars)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
X3=(rand(n,1)-0.5)*sqrt(12); 

X4=(rand(n,1)-0.5)*sqrt(12);
...
Zb(:,2)=[ones(n,1),X3,X4]*gamma(:,1);                                            % The second cut-point
if nc>=2
    for i=3:nc+1
        Zb(:,i)=Zb(:,i-1)+exp([ones(n,1),X3,X4]*gamma(:,i-1));                          % The third, fourth,...
    end
end
...
Simulated.Cut_Indep=[X3,X4];                                                  % Regressors in cut point function
